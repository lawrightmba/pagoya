...
export default function Slide09GoToMarket() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#004F2D" }}>
      <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at 30% 50%, rgba(0,200,117,0.1) 0%, transparent 60%)" }} />
      <div className="absolute left-0 top-0 bottom-0" style={{ width: "0.4vw", background: "linear-gradient(180deg, #00C875 0%, transparent 100%)", opacity: 0.7 }} />
      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "2.5vh 8vw 2vh" }}>
        ...
        <div className="grid grid-cols-3 gap-[2vw]" style={{ marginBottom: "1.2vh", flex: 1, minHeight: 0, overflow: "hidden" }}>
          <div style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "0.8vw", padding: "1.2vh 1.6vw", overflow: "hidden" }}>
          ...
          <div style={{ background: "rgba(0,200,117,0.08)", border: "1px solid rgba(0,200,117,0.2)", borderRadius: "0.8vw", padding: "1.2vh 1.6vw", overflow: "hidden" }}>
          ...
          <div style={{ background: "rgba(255,92,26,0.08)", border: "1px solid rgba(255,92,26,0.2)", borderRadius: "0.8vw", padding: "1.2vh 1.6vw", overflow: "hidden" }}>
        ...
        <div style={{ background: "rgba(0,200,117,0.1)", borderLeft: "0.4vw solid #00C875", padding: "1.4vh 2.5vw", borderRadius: "0 0.6vw 0.6vw 0", flexShrink: 0 }}>
