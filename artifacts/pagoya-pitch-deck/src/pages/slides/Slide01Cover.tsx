...
export default function Slide01Cover() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#004F2D" }}>
      ...
      <div className="absolute inset-0 flex flex-col justify-between" style={{ padding: "5.5vh 8vw 4.5vh" }}>
        <div style={{ maxWidth: "68vw" }}>
          ...
          <div style={{ width: "8vw", height: "0.5vh", background: "#FF5C1A", marginBottom: "2.5vh" }} />
          <p
            style={{
              fontFamily: "DM Sans, sans-serif",
              fontSize: "1.95vw",
          ...
          <div className="flex items-center gap-[2vw]">
            <div style={{ background: "rgba(0,200,117,0.12)", border: "1px solid rgba(0,200,117,0.3)", borderRadius: "0.5vw", padding: "0.6vh 1.2vw" }}>
              <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: "1.4vw", color: "#00C875", fontWeight: 700 }}>
                {es ? "PTI v5.0 · 90+ señales · Certificado fair-lending" : "PTI v5.0 · 90+ signals · Fair-lending certified"}
              </p>
            </div>
            <div style={{ background: "rgba(255,92,26,0.1)", border: "1px solid rgba(255,92,26,0.3)", borderRadius: "0.5vw", padding: "0.6vh 1.2vw" }}>
              <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: "1.4vw", color: "#FF5C1A", fontWeight: 700 }}>
        ...
        <div className="flex items-center gap-[3vw]">
          <span style={{ fontFamily: "DM Sans, sans-serif", fontSize: "1.55vw", color: "rgba(255,255,255,0.5)" }}>
            pagoyamx.com
          </span>
