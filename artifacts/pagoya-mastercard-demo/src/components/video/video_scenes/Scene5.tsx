...
export function Scene5() {
  ...
  return (
    ...
    >
      ...
      >
        <StatCard value={t.stat1val} label={t.stat1label} phase={phase} threshold={1} />
        <StatCard value={t.stat2val} label={t.stat2label} phase={phase} threshold={2} color="#00C875" />
        <StatCard value={t.stat3val} label={t.stat3label} phase={phase} threshold={3} color="#FF5C1A" />
      </motion.div>
      ...
      >
        ...
        <motion.div
          className="text-[2.5vw] font-medium text-white tracking-wide text-center"
