      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        {tab === "content" && (() => {
          ...
          const posts = [
            ...
            {
              week: 2, date: "Jul 8, 2026", status: "ready",
              title: "What $58B in US-MX remittances tells you about creditworthiness",
              angle: "Data + Insight",
              copy: `$58,000,000,000.\n\nThat's how much flowed from the US to Mexico last year in remittances alone.\n\nEvery dollar sent by someone disciplined enough to work, save, and wire money home — month after month, without fail.\n\nAnd on the receiving end? A mother, a brother, a grandmother who takes that money and does something remarkably boring with it: pays CFE. Pays the water bill. Pays for internet so the kids can do homework.\n\nReliably. Predictably. For years.\n\nNone of that shows up in a credit file. Not the sender's discipline. Not the recipient's consistency. $58B a year in provable financial behavior, and it's invisible to every lender on both sides of the border.\n\nThat's not a inclusion problem. That's a measurement problem.\n\nWe built PagoYa's Predictive Trust Index around this exact gap — remittance inflow patterns are one of 90+ behavioral signals we track, alongside bill payment timing and service diversity. The data was always there. Nobody was capturing it.\n\nGenuine question for anyone building in payments or credit infra: if you could see one hidden financial behavior turned into usable data, what would it be?\n\n#Remittances #FinancialInclusion #AlternativeCredit #Fintech #LATAM #PredictiveTrustIndex`,
              tagSuggestions: "Accion Venture Lab, Quona Capital, Dalus Capital (Mexico City) — all active LATAM financial-inclusion investors worth tagging or mentioning in the first comment.",
            },
            {
