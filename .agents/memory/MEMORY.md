...
- [Pitch deck language toggle](pitch-deck-lang.md) — LANG is build-time only in artifacts/pagoya-pitch-deck/src/lang.ts; change 'es'↔'en' then re-export PDF; no runtime toggle exists; slide manifest positions ≠ file names — always check slides-manifest.json
